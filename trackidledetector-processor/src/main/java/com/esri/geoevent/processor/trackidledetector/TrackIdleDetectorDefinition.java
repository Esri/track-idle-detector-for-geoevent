...
public class TrackIdleDetectorDefinition extends GeoEventProcessorDefinitionBase
{
	...
	public TrackIdleDetectorDefinition()
	{
		try
		{
			...
			propertyDefinitions.put("outGedName", new PropertyDefinition("outGedName", PropertyType.String, "", "${com.esri.geoevent.processor.trackidledetector-processor.PROCESSOR_OUT_GED_NAME_LBL}", "${com.esri.geoevent.processor.trackidledetector-processor.PROCESSOR_OUT_GD_NAME_DESC}", true, false));
